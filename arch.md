...
## Почему не WebSocket
По большей части нам не нужен настоящий real-time в данной задаче и постоянные висящие коннекты нам будут скорее мешать, чем помогать

Вполне хватает переодического дерганья сервера, либо можно настроить longpooling 
...
Можно было бы класть ставки входящие в очередь и обрабатывать в фоне, но есть trade-off, можем не успеть обработать ставку до конца раунда
